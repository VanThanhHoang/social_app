...
const data: DataItem[] = [
  {
    ...
    title: 'Messi',
    description:
      'Una cosa que siempre me da buenas sensaciones… arrancar la nueva temporada con mis nuevos botines. Vamos @adidasfootball 👟💪',
    tag: 'adidasfootball',
    image: images.messi,
    star: 15700,
    comment: 9696,
  ...
  },
  {
    ...
    title: 'Nike',
    description:
      'Tell us how you style your Nike Acronym. Full techwear? Mix and match? Let us know 👀',
    tag: 'Nike',
  ...
  },
  {
    ...
    title: 'pewdiepie',
    description:
      'Green flag to those people who updates you because they know how you over thinking while waiting for them',
    ...
    <GestureHandlerRootView style={{flex: 1}}>
        ...
        <BottomSheet
          ...
          <View style={styles.contentContainer}>
            ...
            <Text style={{marginTop: 8}}>
              Choose what you want us to show you
            </Text>
            <View
              style={{
                width: 326,
      ...
      <View style={{width: 406, height: '100%', flex: 1, position: 'absolute'}}>
        {isBottomSheet && (
          <TouchableOpacity
            style={styles.overlay}
            onPress={() => toggleBottomSheet1('', null)}
            activeOpacity={0.1}
          />
        )}
        <BottomSheet
